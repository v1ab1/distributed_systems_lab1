...
async def person_not_found_error_handler(_: Request, exc: PersonNotFoundError) -> JSONResponse:
...
def add_exception_handlers(app: FastAPI) -> None:
    app.add_exception_handler(PersonNotFoundError, person_not_found_error_handler)  # type: ignore
